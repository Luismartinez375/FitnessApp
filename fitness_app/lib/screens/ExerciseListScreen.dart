...
final exercisesByCategory = {
  ...
  'Back': [
    ...
    {'imageUrl': 'assets/images/back/incline_dumbbell_row.JPG', 'name': 'Incline Dumbell Row'},
    {'imageUrl': 'assets/images/back/incline_reverse_fly.JPG', 'name': 'Incline Reverse Fly'},
    {'imageUrl': 'assets/images/back/lat_pull_down.JPG', 'name': 'Lat Pull Down'},
    {'imageUrl': 'assets/images/back/pull_up.JPG', 'name': 'Pull Up'},
    {'imageUrl': 'assets/images/back/seated_row.JPG', 'name': 'Seated Row'},
  ],

  'Bicep': [
    {'imageUrl': 'assets/images/bicep/barbell_curls.JPG', 'name': 'Barbell Curls'},
    {'imageUrl': 'assets/images/bicep/hammer_curls.JPG', 'name': 'Hammer Curls'},
    {'imageUrl': 'assets/images/bicep/incline_dumbell_curls.JPG', 'name': 'Incline Dumbell Curls'},
    {'imageUrl': 'assets/images/bicep/standing_biceps_cable_curl.JPG', 'name': 'Standing Biceps Cable Curl'},
  ],

  'Chest': [
    {'imageUrl': 'assets/images/chest/bench_press.JPG', 'name': 'Bench Press'},
    {'imageUrl': 'assets/images/chest/cable_cross_over.JPG', 'name': 'Cable Cross Over'},
    {'imageUrl': 'assets/images/chest/incline_bench_press.JPG', 'name': 'Incline Bench Press'},
    {'imageUrl': 'assets/images/chest/pec_fly.JPG', 'name': 'Pec Fly'},
    {'imageUrl': 'assets/images/chest/push_up.JPG', 'name': 'Push Up'},
  ],

  'Legs': [
    {'imageUrl': 'assets/images/legs/barbell_deadlift.JPG', 'name': 'Barbell Deadlift'},
    {'imageUrl': 'assets/images/legs/barbell_front_squat.JPG', 'name': 'Barbell Front Squat'},
    {'imageUrl': 'assets/images/legs/dumbell_lunges.JPG', 'name': 'Dumbell Lunges'},
    {'imageUrl': 'assets/images/legs/leg_extension.JPG', 'name': 'Leg Extension'},
    {'imageUrl': 'assets/images/legs/leg_press.JPG', 'name': 'Leg Press'},
    {'imageUrl': 'assets/images/legs/lying_leg_curl.JPG', 'name': 'Lying Leg Curl'},
    {'imageUrl': 'assets/images/legs/seated_calf_raise.JPG', 'name': 'Seated Calf Raise'},

  ],

  'Shoulder': [
    {'imageUrl': 'assets/images/shoulder/dumbbell_raise.JPG', 'name': 'Dumbbell Raise'},
    {'imageUrl': 'assets/images/shoulder/dumbell_lateral_raise.JPG', 'name': 'Dumbell Lateral Raise'},
    {'imageUrl': 'assets/images/shoulder/seated_barbell_shoulder_press.JPG', 'name': 'Seated Barbell Shoulder Press'},
  ],

  'Tricep': [
    {'imageUrl': 'assets/images/tricep/cable_overhead_tricep_extension.JPG', 'name': 'Cable Overhead Tricep Extension'},
    {'imageUrl': 'assets/images/tricep/seated_triceps_press.JPG', 'name': 'Seated Triceps Press'},
  ],
  ...
  Future<void> _saveExercise(String imageUrl, String exerciseName, int sets, int reps) async {
  ...
  if (_selectedCategory == null || !exercisesByCategory.containsKey(_selectedCategory)) {
